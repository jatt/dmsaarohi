...
function PageShell({ basePath = "/home", children, isNgo = false, isMusic = false }) {
  ...
  return (
    <div
      className={`min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(171,63,45,0.18),transparent_28%),radial-gradient(circle_at_right_center,rgba(204,160,87,0.24),transparent_24%),linear-gradient(180deg,#f8f0e4_0%,#efe1cf_100%)] px-4 py-4 text-stone-900 md:px-6 ${showNgoNavbar || showMusicNavbar ? "pt-24 sm:pt-24" : ""}`}
      style={{ scrollPaddingTop: showNgoNavbar || showMusicNavbar ? "6rem" : "0" }}
    >
