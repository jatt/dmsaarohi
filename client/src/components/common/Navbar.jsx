...
function Navbar({ basePath = "/" }) {
  ...
  const navItems = [
    ...
    { label: "Selection", href: `${basePath}#selection` },
    { label: "About", href: `${basePath}#about` },
    { label: "Team", href: `${basePath}#team` },
    { label: "Contact", href: `${basePath}#contact` },
    { label: "Get Involved", href: `${basePath}#cta` }
  ];

  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/40 bg-white/80 shadow-lg backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-5 px-5 py-4 md:px-6">
          ...
          <nav
            ...
            } absolute left-0 top-[82px] w-full flex-col gap-4 border-t border-stone-200 bg-white/95 px-5 py-4 text-sm font-semibold text-stone-700 shadow-lg md:static md:flex md:w-auto md:flex-row md:items-center md:gap-5 md:border-none md:bg-transparent md:p-0 md:shadow-none`}
          >
